...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def on_pushButton_7_clicked(self):
        ...
        try:
            ...
            video = cv2.VideoCapture(self.file_dir)
            ...
            while True:
                ...
                if not ret:  # 如果视频已经播放完毕，则退出循环
                    break
                img_rows, img_cols, channels = frame.shape
                bytesPerLine = channels * img_cols
                roi, label, color = Videodetect(frame)
...
if __name__ == "__main__":
    ...
    splash = QSplashScreen(QtGui.QPixmap('D:/Anaconda/shipingchuli/vehicle-license-plate-recognition-master/pic/1.png'))
